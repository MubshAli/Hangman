...
def set_input(lst):
    ...
    '''
    we tried adding a newline character to the first listed value, to begin printing 
    on the line after the input prompt, but this made all comparisons tests fail, owing
    to the unexpected new character. For future reference, don't try this [Winter 2017]
    '''
